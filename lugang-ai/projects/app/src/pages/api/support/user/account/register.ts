...
import { verifyAuthCode, UserAuthTypeEnum } from '../inform/sendAuthCode';
        ...
        [
          {
            ...
            // 鲁港通 - 4.16.2 TeamMemberRoleEnum 仅保留 owner；普通成员省略 role 字段（isOwner=false，权限由 MongoResourcePermission 控制）
