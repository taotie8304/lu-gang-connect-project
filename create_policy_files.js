...
We reserve the right to amend the terms of this Privacy Policy in our absolute discretion. We will notify you of any amendments by publishing the revised policy and updated version date on the Service's mobile application and/or website. If you continue to access and use the Service after the latest updated version date, you shall be deemed to have read and accepted the updated Privacy Policy. If you do not agree, please immediately cease accessing and using the Service.
...
console.log('Creating privacy_policy_en.txt...');
fs.writeFileSync('privacy_policy_en.txt', PRIVACY_POLICY_EN, 'utf8');
console.log('✅ Created privacy_policy_en.txt');

console.log('\n✅ All policy files created successfully!');
console.log('\nNext steps:');
console.log('1. Run: node add_privacy_and_data_collection.js');
console.log('2. This will add all policies to the database');
