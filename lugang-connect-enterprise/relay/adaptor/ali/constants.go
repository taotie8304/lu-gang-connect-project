...
var ModelList = []string{
	// ===== Qwen3.5 系列（最新，支持 thinking + 联网搜索） =====
	...
	// 联网搜索版本（-internet 后缀自动启用 enable_search）
	"qwen3.5-flash-internet", "qwen3.5-plus-internet",
	...
	// 联网搜索版本
	"qwen-turbo-internet", "qwen-plus-internet", "qwen-max-internet",
	...
	"qwen1.5-7b-chat", "qwen1.5-1.8b-chat", "qwen1.5-0.5b-chat",
